...
namespace detail{
    ...
    struct extent_imp {
        static const size_t value = __array_extent(T, N);
    };
...
template <class T, size_t R, size_t N>
struct extent_imp<T[R], N>
{
   BOOST_STATIC_CONSTANT(size_t, value = (::boost::detail::extent_imp<T, N-1>::value));
};
...
{
   BOOST_STATIC_CONSTANT(size_t, value = R);
};
...
struct extent
   : public ::boost::integral_constant<size_t, ::boost::detail::extent_imp<T,N>::value>
{
};
