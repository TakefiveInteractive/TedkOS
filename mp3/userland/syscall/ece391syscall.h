...
extern int32_t ece391_execute (const char* command);
...
extern int32_t ece391_open (const char* filename);
...
extern int32_t ece391_fstat (int file, struct stat *st);
extern int32_t ece391_lseek (int32_t file, int32_t ptr, int32_t dir);
