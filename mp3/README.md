...
### Kernel source code: student-distrib/
...
### userland/
	This is where we built the newlibs c library. Together with syscall library in /syscalls/, it is the best way to create a user program for our OS.
...
### createfs
    This Linux/Mac program takes a flat source directory (i.e. no subdirectories
...
### elfconvert
    This Linux/Mac program takes a 32-bit ELF (Executable and Linking Format) file
